...
public class ActivityLihatData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //membuat veriabel dengan jenis data bundle dan
        //assign value daro variabel tersebut dengan
        //getIntent().getExtras()
        Bundle bundle = getIntent().getExtras();

        //Membuat variabel nama dan assign value dari pesan
        //yang dikirim dari activity sebelumnya
        String nama = bundle.getString("a");

        //Membuat fungsi untuk mengatur TextView nama dan nomor telepon
        //berdasrkan pesan yang dikirim dari activity sebelumnya
        switch (nama){
            case "Inayah":
